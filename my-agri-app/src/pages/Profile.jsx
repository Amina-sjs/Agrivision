...
const Profile = ({ lang }) => {
    ...
    const fetchUserProfile = async () => {
        ...
        try {
            // Получаем ID пользователя из MemoryStorage
            ...
            console.log('📥 Запрашиваем профиль для ID:', userId);
            
            // ✅ Используем правильный эндпоинт из ТЗ: GET /user/:id
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            const userId = MemoryStorage.getUserId();
            console.log('💾 Сохраняем профиль для ID:', userId);
            
            // ✅ Используем правильный эндпоинт из ТЗ: PATCH /user/:id
            ...
            // Обновляем данные в MemoryStorage
            const updatedUser = {
                ...user,
                name: formData.name,
                phone: formData.phone,
    ...
    return (
        <div className="container" style={{ paddingTop: '100px', maxWidth: '800px' }}>
            ...
            <div style={{
                ...
                <div>ID пользователя: <code>{MemoryStorage.getUserId()}</code></div>
                <div style={{ marginTop: '5px' }}>Эндпоинт профиля: <code>/user/{MemoryStorage.getUserId()}</code></div>
            </div>
        </div>
    );
};
